...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<Map<String, Object>> handleGeneric(Exception ex) {
    // Log the full stack trace: an unexpected 500 is a bug we must be able to diagnose. Without
    // this, the catch-all silently swallows the cause and the server logs show nothing.
